...
predFile = args.input+'/prediction_only1000HT.csv'
import pandas as pd
...
if not os.path.exists(predFile):
	...
	myDataset = MyDataset()
	basedir = "../../Data_directory/32PU_fulldata/preprocessed_cnt/"
	myDataset.addSample("RPV_1400", basedir+"RPV/*.h5", weight=0.013/330599)
	#myDataset.addSample("QCD_HT700to1000" , basedir+"QCD/HT700to1000/*/*.h5", weight=???)
	myDataset.addSample("QCD_HT1000to1500", basedir+"QCDHT1000/*.h5", weight=1094./15466225)
	...
	print(" ##################################### " )
	print(trnDataset.height, valDataset, testDataset)
