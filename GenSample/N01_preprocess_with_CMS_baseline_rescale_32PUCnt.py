...
BKG_weight_sum  = QCD1000 + QCD1500 + QCD2000
...
if (args.train_data != None):
	...
	print("## QCD 1000-1500 ##")
	print("Initial_QCD_1000_weight: ",Norm_QCD1000) 
...
if (args.train_data != None):
	...
	with h5py.File("HEPdata_NEW/Merging_dir_forHT700bin/2020_CMScut_32PU_v2_full/TrackCnt/"+args.train_out_name,"w") as f:
...
if (args.val_data != None):
	...
	with h5py.File("HEPdata_NEW/Merging_dir_forHT700bin/2020_CMScut_32PU_v2_full/TrackCnt/"+args.val_out_name,"w") as f:
		g=f.create_group("all_events")
...
if (args.test_data != None):
	...
	with h5py.File("HEPdata_NEW/Merging_dir_forHT700bin/2020_CMScut_32PU_v2_full/TrackCnt/"+args.test_out_name,"w") as f:
		g=f.create_group("all_events")
