...
with h5py.File("HEPdata_NEW/Merging_dir_forHT700bin/Preprocessed_Train.h5","w") as f:
...
with h5py.File("HEPdata_NEW/Merging_dir_forHT700bin/Preprocessed_Val.h5","w") as f:
	g=f.create_group("all_events")
...
with h5py.File("HEPdata_NEW/fortest/Preprocessed_Test.h5","w") as f:
	g=f.create_group("all_events")
