...
dir_64= '/scratch/x1797a07/HEP-CNN/run/CMSFull_nurion_KNL_torch32K/SELECT_64__BATCH_512/history_0.csv'
dir_128= '/scratch/x1797a07/HEP-CNN/run/CMSFull_nurion_KNL_torch32K/SELECT_128__BATCH_256/history_0.csv'
dir_256= '/scratch/x1797a07/HEP-CNN/run/CMSFull_nurion_KNL_torch32K/SELECT_256__BATCH_128/history_0.csv'
dir_512= '/scratch/x1797a07/HEP-CNN/run/CMSFull_nurion_KNL_torch32K/SELECT_512__BATCH_64/history_0.csv'
dir_1024= '/scratch/x1797a07/HEP-CNN/run/CMSFull_nurion_KNL_torch32K/SELECT_1024__BATCH_32/history_0.csv'
dir_2048= '/scratch/x1797a07/HEP-CNN/run/CMSFull_nurion_KNL_torch32K/SELECT_2048__BATCH_16/history_0.csv'
...
time.append(data4096_df['time'][:50].sum(axis=0))
...
print(data4096_df['time'][:50].shape[0])
