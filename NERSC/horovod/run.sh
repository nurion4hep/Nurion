...
#PBS -A etc
#PBS -l select=4:ncpus=68:mpiprocs=1:ompthreads=64
...
mpirun -np 4 python train_only.py --nb-epochs 20 --nb-train-events 412416  --batch-size 512 data/Preprocessed_Train.h5 data/Preprocessed_Val.h5 3ch-CNN 
